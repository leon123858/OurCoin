...

{
  ...
  for (let i = 0; i < 10000; i++) TX.fromRaw(raw);
...

{
  ...
  for (let i = 0; i < 100000; i++) tx.getSigopsCost(view);
...

{
  ...
  for (let i = 0; i < 10000; i++) tx.isSane();
...

{
  ...
  for (let i = 0; i < 10000; i++) tx.getInputHashes();
...

{
  ...
  for (let i = 0; i < 10000; i++) tx.getOutputHashes();
...

{
  ...
  for (let i = 0; i < 10000; i++) tx.getHashes();
...

{
  ...
  for (let i = 0; i < 30000; i++) tx.verify(view, Script.flags.VERIFY_P2SH);
...

{
  ...
  for (let i = 0; i < 10000; i++) tx.getFee(view);
...

{
  ...
  for (let i = 0; i < 30000; i++) tx.verify(view, flags);
...

{
  ...
  for (let i = 0; i < 10000; i++) tx2.getInputHashes();
...

{
  ...
  for (let i = 0; i < 10000; i++) tx2.getOutputHashes();
...

{
  ...
  for (let i = 0; i < 10000; i++) tx2.getHashes();
