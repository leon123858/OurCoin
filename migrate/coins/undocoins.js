...
UndoCoins.prototype.fromRaw = function fromRaw(data) {
  ...
  for (let i = 0; i < count; i++) this.items.push(UndoCoin.fromReader(br));
...
UndoCoin.prototype.getSize = function getSize() {
  ...
  if (this.height !== -1) size += encoding.sizeVarint(this.version);
...
UndoCoin.prototype.fromReader = function fromReader(br) {
  ...
  if (this.height !== -1) this.version = br.readVarint();
