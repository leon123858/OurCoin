...
class Address {
  ...
  getPrefix(network) {
    if (this.isProgram()) return this.version;
  ...
  toString(network) {
    if (this.version !== -1) {
      if (this.version === 0) return this.toBech32(network);
  ...
  fromHash(hash, type, version) {
    ...
    assert(
      type >= Address.types.PUBKEYHASH && type <= Address.types.WITNESS,
