...
describe("Address", function () {
  ...
  it("should handle invalid segwit program length 2", () => {
    const addr =
      "bc10w508d6qejxtdg4y5r3zarvary0c5xw7kw5" +
  ...
  it("should handle segwit mixed case", () => {
    const addr =
      "tb1qrp33g0q5c5txsp9arysrx4k6z" + "dkfs4nce4xj0gdcccefvpysxf3q0sL5k7";
    assert.throws(() => Address.fromString(addr, "main"));
  });
  ...
  it("should handle segwit non-zero padding in 8-to-5 conversion", () => {
    const addr =
      "tb1qrp33g0q5c5txsp9arysrx4k6" + "zdkfs4nce4xj0gdcccefvpysxf3pjxtptv";
    assert.throws(() => Address.fromString(addr, "main"));
  });
  ...
  it("should identify witness (not version 0) address", () => {
    ...
    for (const addr of addresses) {
      ...
      assert.strictEqual(parsed.getPrefix(network), parsed.version);
    }
  });
});
