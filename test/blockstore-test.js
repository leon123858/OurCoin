...
const extra = [common.readBlock("block482683")];
...
const merkles = [common.readMerkle("merkle300025-extended")];
...
const { BlockRecord, FileRecord } = require("../lib/blockstore/records");
